...
export default function Landing({ onAuthenticated }) {
  ...
  return <div className="landing">
    ...
    <main id="inicio" className="hero"><div className="hero-copy"><span className="hero-kicker">Inteligencia comercial para empresas</span><h1>Las oportunidades de Mercado Público, en un solo lugar.</h1><p>Encuentra licitaciones y compras ágiles relevantes para tu negocio. Filtra el ruido, guarda tus criterios y recibe nuevas oportunidades directamente en tu correo.</p><div className="hero-actions"><button onClick={() => { changeMode('register'); setAuthOpen(true); }}>Comenzar gratis</button><a href="#funciones">Ver cómo funciona <span>↓</span></a></div><div className="hero-trust"><span>Datos sincronizados</span><span>Filtros inteligentes</span><span>Alertas programadas</span></div></div><div className="hero-preview"><div className="preview-bar"><i /><i /><i /><span>Oportunidades / Licitaciones</span></div><small>OPORTUNIDADES ACTIVAS</small><strong>Mercado Público, más simple.</strong><div className="preview-metric"><b>4.215</b><span>Licitaciones monitoreadas</span></div><div className="preview-row"><i /><span><b>Servicio de mantenimiento integral</b><small>Región Metropolitana · Cierra mañana</small></span><em>Publicada</em></div><div className="preview-row"><i /><span><b>Adquisición de equipamiento</b><small>Compra Ágil · Publicada hoy</small></span><em>Nueva</em></div></div></main>
    <section id="funciones" className="features"><div><small>UN FLUJO MÁS SIMPLE</small><h2>Menos tiempo buscando.<br />Más tiempo ofertando.</h2><p>Una herramienta enfocada en ayudarte a descubrir y seguir oportunidades comerciales.</p></div><article><span>01</span><h3>Todo centralizado</h3><p>Consulta licitaciones y compras ágiles desde una interfaz rápida y ordenada.</p></article><article><span>02</span><h3>Solo lo relevante</h3><p>Combina palabras clave, exclusiones, organismos, regiones y rubros oficiales.</p></article><article><span>03</span><h3>Sin revisar a diario</h3><p>Programa búsquedas y recibe por correo solamente las oportunidades relevantes.</p></article></section>
